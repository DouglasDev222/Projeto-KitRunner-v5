// Script para atualizar as políticas com os Termos e Condições Gerais da KITRUNNER
const generalTermsContent = `<h1>Termos e Condições Gerais de Uso da KITRUNNER SOLUÇÕES E SERVIÇOS</h1>
...
const orderSpecificTermsContent = `<h1>Política de Pedidos e Entrega</h1>

<h2>Condições Específicas para Pedidos</h2>
<p>Ao realizar um pedido através da plataforma KITRUNNER, o cliente aceita as seguintes condições específicas:</p>

<h2>Processo de Pedido</h2>
<ul>
  <li>O pedido será considerado confirmado apenas após o pagamento integral do valor</li>
  <li>A confirmação será enviada por e-mail dentro de 24 horas</li>
  <li>Alterações no pedido podem ser solicitadas até 48 horas antes da retirada do kit</li>
</ul>

<h2>Entrega</h2>
<p>A entrega será realizada no endereço informado no momento do pedido, observando:</p>
<ul>
  <li>Prazo de entrega: até 2 dias úteis após a retirada do kit</li>
  <li>Horário de entrega: segunda a sexta-feira, das 8h às 18h</li>
  <li>É necessária a presença de uma pessoa maior de idade no endereço</li>
  <li>Documento de identificação será solicitado na entrega</li>
</ul>

<h2>Responsabilidades do Cliente</h2>
<ul>
  <li>Fornecer endereço completo e correto</li>
  <li>Estar disponível no horário combinado para entrega</li>
  <li>Verificar os dados do pedido antes da confirmação</li>
  <li>Comunicar eventuais alterações de endereço com antecedência</li>
</ul>`;

console.log('Conteúdo dos Termos Gerais extraído com sucesso!');
console.log('Tamanho:', generalTermsContent.length, 'caracteres');
console.log('Conteúdo específico de pedidos criado!');
console.log('Tamanho:', orderSpecificTermsContent.length, 'caracteres');